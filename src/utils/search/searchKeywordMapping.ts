...
export const DEPARTMENT_MAPPING: Record<DepartmentCode, string> = {
    // 공학대학
    ARCHITECTURE: '건축학부',
    CONSTRUCTION_ENVIRONMENT: '건설환경공학과',
    TRANSPORT_LOGISTICS: '교통·물류공학과',
    ELECTRICAL_ENGINEERING: '전자공학부',
    BATTERY_MATERIAL_CHEMICAL: '배터리소재화학공학과',
    MATERIAL_CHEMICAL: '재료화학공학과',
    MECHANICAL: '기계공학과',
    INDUSTRIAL_MANAGEMENT: '산업경영공학과',
    ROBOT: '로봇공학과',
    FUSION_SYSTEM: '융합시스템공학과',
    SMART_FUSION: '스마트융합공학부',
    INTELLIGENT_ROBOT: '지능형로봇학과',
    ENERGY_BIO: '에너지바이오학과',
    MARINE_FUSION: '해양융합공학과',
