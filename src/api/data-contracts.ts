...
/** DTO for recruitment alert subscribe request */
export interface RecruitmentAlertSubscribeRequest {
  /**
   * Email to receive recruitment start alerts
...
export interface ApiResponseGetRegistrationResponse {
  isSuccess?: boolean;
  code?: string;
  message?: string;
  result?: GetRegistrationResponse;
}
...
export interface ApiResponseGetInstagramsMain {
  isSuccess?: boolean;
  code?: string;
  message?: string;
  result?: GetInstagramsMain;
}

export interface GetInstagramsMain {
  officialAccounts?: ClubInstagramDTO[];
}
...
export interface SubscribeRecruitmentAlertParams {
  /** @format int64 */
  clubId: number;
}
...
export interface GetClubRegistrationParams {
  /** @format int64 */
  clubRegistrationId: number;
}
